...
(async function() {
  const allVersion = (await axios.get("https://github.com/anhloan88aa/QUYEN/raw/main/versions.json")).data;
  ...
  for (let data of versionsUpdate) {
    for (let location in data.info) {
      ...
      const response = (await axios.get("https://github.com/anhloan88aa/QUYEN/raw/main/" + location, {
  ...
  const packageJson = (await axios.get("https://github.com/anhloan88aa/QUYEN/raw/main/package.json")).data;
